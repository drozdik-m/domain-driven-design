...
{
    private static readonly Error s_notFound = new (ErrorCodes.NotFound, WellKnownErrors.NotFound, []);
    private static readonly Error s_alreadyExists = new (ErrorCodes.AlreadyExists, WellKnownErrors.AlreadyExists, []);
