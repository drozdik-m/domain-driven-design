...
internal static class ServiceCollectionExtensions
{
    ...
    {
        services.AddTransient<ICommandHandler<TestUnitCommand1>, TestVoidCommand1Handler>();
        services.AddTransient<ICommandHandler<TestUnitCommand2>, TestVoidCommand2Handler>();
