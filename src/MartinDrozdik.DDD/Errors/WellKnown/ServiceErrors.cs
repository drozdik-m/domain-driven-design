...
{
    private static readonly Error s_notFound = new(ErrorCodes.NotFound, WellKnownErrorMessages.NotFound, []);
    private static readonly Error s_alreadyExists = new(ErrorCodes.AlreadyExists, WellKnownErrorMessages.AlreadyExists, []);
