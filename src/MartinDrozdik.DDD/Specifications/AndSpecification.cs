...
public class AndSpecification<TContext> : ISpecification<TContext>
{
    private readonly ISpecification<TContext>[] _specifications;

    /// <summary>
    /// Initializes a new instance of the <see cref="AndSpecification{TContext}"/> class.
    /// </summary>
    /// <param name="specifications">The specifications to combine using a logical AND operation.</param>
    public AndSpecification(params IEnumerable<ISpecification<TContext>> specifications)
    {
    ...
    /// Initializes a new instance of the <see cref="AndSpecification{TContext}"/> class.
    /// </summary>
    /// <param name="specification">A specifications to combine using a logical AND operation.</param>
    /// <param name="others">The specifications to combine using a logical AND operation.</param>
    public AndSpecification(ISpecification<TContext> specification, params ISpecification<TContext>[] others)
    {
