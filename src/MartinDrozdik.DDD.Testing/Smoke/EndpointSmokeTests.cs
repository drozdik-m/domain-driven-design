...
public abstract partial class EndpointSmokeTests<TProgram> : IDisposable
    where TProgram : class
{
    private readonly TestedApp<TProgram> _factory;

    /// <summary>
    /// Initializes a new instance of the <see cref="EndpointSmokeTests{TProgram}"/> class.
    /// </summary>
    /// <param name="builder">App factory under test.</param>
    protected EndpointSmokeTests(TestedAppBuilder<TProgram> builder)
    {
