...
Provides skills that give Claude deep knowledge of `MartinDrozdik.DDD`, `MartinDrozdik.DDD.Web`, and `MartinDrozdik.DDD.Testing` – slash commands, auto-triggering on library usage, and more accurate code generation out of the box.

Install in two steps inside Claude Code:
...
Check out [very nice README.md](./claude/README.md) for available skills and usage examples.
